...
interface ProductCategoryBulkDeleteDialogProps {
  open: boolean
  onOpenChange: (open: boolean) => void
  onConfirm: (ids: string[]) => void
  selectedRows: ProductCategory[]
  isLoading?: boolean
}

export function ProductCategoryBulkDeleteDialog({
  open,
  onOpenChange,
  onConfirm,
  selectedRows,
  isLoading,
}: ProductCategoryBulkDeleteDialogProps) {
    ...
    <ConfirmDialog
      ...
      title={
        <div className='flex items-center gap-2'>
          ...
          <span>Hapus Multiple Kategori Produk</span>
        </div>
      }
      destructive
        ...
        <div className='mt-2 space-y-4 text-start'>
          ...
          >
            ...
            <AlertDescription className='text-xs opacity-90'>
              Anda akan menghapus{' '}
              <strong>{selectedRows.length} kategori produk</strong>. Tindakan
