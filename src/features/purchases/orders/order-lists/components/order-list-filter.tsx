...
export function OrderListFilter({
  ...
  const tagOptions =
    tagsData?.data.map((tag) => ({ label: tag.name, value: tag.id })) ?? []
  const userOptions =
  ...
  useEffect(() => {
    const syncStateFromUrl = () => {
      ...
      setSelectedVendorId(getParam('vendor_id'))
      ...
      setAttachmentFilter(
        (getParam('has_attachment') as 'all' | 'true' | 'false') || 'all'
      )
    }
  ...
  const handleApply = () => {
    ...
    newParams['vendor_id'] = selectedVendorId
    newParams['tags'] =
    ...
    newParams['has_attachment'] =
      attachmentFilter !== 'all' ? attachmentFilter : undefined
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent
        className='w-[calc(100vw-2rem)] p-0 md:w-[850px]'
        align='start'
        side='right'
      >
        <div className='flex h-full flex-col'>
          <div className='flex items-center justify-between border-b px-4 py-2'>
            <h4 className='font-medium'>Filter Pesanan Pembelian</h4>
            <Button
              variant='ghost'
              size='sm'
              onClick={handleReset}
          ...
          <div className='grid max-h-[60vh] grid-cols-1 divide-y overflow-y-auto md:grid-cols-3 md:divide-x md:divide-y-0'>
            ...
            <div className='scrollbar-thin space-y-4 overflow-y-auto p-4'>
              <h5 className='text-muted-foreground mb-4 text-xs font-bold tracking-wider uppercase'>
                Tanggal
              </h5>
            ...
            <div className='scrollbar-thin space-y-4 overflow-y-auto p-4'>
              ...
              <div className='space-y-2'>
                ...
                <Select
                  ...
                  onValueChange={setSelectedExpeditionId}
                >
                  <SelectTrigger className='h-8 text-xs'>
