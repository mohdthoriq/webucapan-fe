...
interface PurchasesOrdersTablePrintProps {
  className?: string
}

export const PurchasesOrdersTablePrint = forwardRef<
  HTMLDivElement,
  PurchasesOrdersTablePrintProps
>(({ className }, ref) => {
...
PurchasesOrdersTablePrint.displayName = 'PurchasesOrdersTablePrint'
