...
interface PurchaseDeliveryDetailReceiptProps {
  delivery: PurchaseDelivery
}

export function PurchaseDeliveryDetailReceipt({
  delivery,
}: PurchaseDeliveryDetailReceiptProps) {
  return (
      ...
      <CardContent className='px-4 pt-4'>
        ...
        <div className='overflow-hidden rounded-md border'>
          <Table>
            ...
            <TableBody>
              {delivery.purchase_invoice_items.map((item, idx) => (
                <TableRow
                  key={idx}
