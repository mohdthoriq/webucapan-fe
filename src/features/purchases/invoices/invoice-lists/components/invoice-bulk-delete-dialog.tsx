...
interface PurchaseInvoiceBulkDeleteDialogProps {
  open: boolean
  onOpenChange: (open: boolean) => void
  onConfirm: (ids: string[]) => void
  selectedRows: PurchaseInvoice[]
  isLoading?: boolean
}

export function PurchaseInvoiceBulkDeleteDialog({
  open,
  onOpenChange,
  onConfirm,
  selectedRows,
  isLoading,
}: PurchaseInvoiceBulkDeleteDialogProps) {
