...
interface PurchaseInvoicesTablePrintProps {
  className?: string
}

export const PurchaseInvoicesTablePrint = forwardRef<
  HTMLDivElement,
  PurchaseInvoicesTablePrintProps
>(({ className }, ref) => {
...
PurchaseInvoicesTablePrint.displayName = 'PurchaseInvoicesTablePrint'
