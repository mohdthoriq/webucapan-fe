...
interface PermissionsBulkDeleteDialogProps {
  open: boolean
...
export function PermissionsBulkDeleteDialog({
  open,
  onOpenChange,
  onConfirm,
  selectedRows,
  isLoading,
}: PermissionsBulkDeleteDialogProps) {
    ...
    <ConfirmDialog
      ...
      title={
        <div className='flex items-center gap-2'>
          ...
          <span>Hapus Multiple Permission</span>
        </div>
      }
      destructive
        ...
        <div className='mt-2 space-y-4 text-start'>
          ...
          >
            ...
            <AlertDescription className='text-xs opacity-90'>
              Anda akan menghapus <strong>{selectedRows.length} permission</strong>.
