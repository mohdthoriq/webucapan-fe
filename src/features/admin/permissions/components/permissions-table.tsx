...
import { useBulkDeletePermissionMutation } from '../hooks/use-permissions-mutation'
import { PermissionsBulkDeleteDialog } from './permissions-bulk-delete-dialog'
...
export function PermissionsTable({ search, navigate }: DataTableProps) {
  ...
  const deleteBulkMutation = useBulkDeletePermissionMutation()
  ...
  return (
    ...
    >
      ...
      <DataTableBulkActions table={table} entityName='Permission'>
        <Tooltip>
