...
interface MenusBulkDeleteDialogProps {
  open: boolean
...
export function MenusBulkDeleteDialog({
  open,
  onOpenChange,
  onConfirm,
  selectedRows,
  isLoading,
}: MenusBulkDeleteDialogProps) {
        ...
        <div className='mt-2 space-y-4 text-start'>
          ...
          >
            ...
            <AlertDescription className='text-xs opacity-90'>
              Anda akan menghapus <strong>{selectedRows.length} menu</strong>.
