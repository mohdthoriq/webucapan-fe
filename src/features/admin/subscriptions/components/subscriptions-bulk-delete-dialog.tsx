...
interface SubscriptionsBulkDeleteDialogProps {
  open: boolean
...
export function SubscriptionsBulkDeleteDialog({
  open,
  onOpenChange,
  onConfirm,
  selectedRows,
  isLoading,
}: SubscriptionsBulkDeleteDialogProps) {
    ...
    <ConfirmDialog
      ...
      title={
        <div className='flex items-center gap-2'>
          ...
          <span>Hapus Multiple Subscription</span>
        </div>
      }
      destructive
      ...
      confirmText='Hapus Subscription'
      desc={
        <div className='mt-2 space-y-4 text-start'>
          ...
          >
            ...
            <AlertDescription className='text-xs opacity-90'>
              Anda akan menghapus{' '}
              <strong>{selectedRows.length} subscription</strong>. Tindakan ini
