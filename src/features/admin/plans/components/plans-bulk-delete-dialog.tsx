...
interface PlansBulkDeleteDialogProps {
  open: boolean
...
export function PlansBulkDeleteDialog({
  open,
  onOpenChange,
  onConfirm,
  selectedRows,
  isLoading,
}: PlansBulkDeleteDialogProps) {
        ...
        <div className='mt-2 space-y-4 text-start'>
          ...
          >
            ...
            <AlertDescription className='text-xs opacity-90'>
              Anda akan menghapus <strong>{selectedRows.length} plan</strong>.
