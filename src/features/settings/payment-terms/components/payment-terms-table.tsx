...
import { PaymentTermsBulkDeleteDialog } from './payment-terms-bulk-delete-dialog'
import { paymentTermsColumns } from './payment-terms-columns'
...
export function PaymentTermsTable({ search, navigate }: DataTableProps) {
  const {
    paymentTermsData,
        ...
        <Table>
          ...
          <TableBody>
            {isLoading ? (
              ...
              <TableEmpty colSpan={paymentTermsColumns.length} />
            )}
          </TableBody>
        </Table>
      </div>
      <DataTablePagination table={table} className='mt-auto' />
      <DataTableBulkActions table={table} entityName='termin pembayaran'>
        <Tooltip>
...
function TableRows({ table }: { table: TanstackTable<PaymentTerm> }) {
