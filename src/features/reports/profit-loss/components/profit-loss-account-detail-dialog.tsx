...
import { useProfitLossContext } from '../components/profit-loss-provider'
...
export function ProfitLossAccountDetailDialog() {
  ...
  const { selectedAccountId, isOpen, closeDetail, period, dateFrom, dateTo } =
          ...
          <div className='flex items-start justify-between'>
            <DialogHeader className='text-left'>
              ...
              <p className='text-muted-foreground text-sm'>
                Periode: {format(dateFrom, 'dd MMM yyyy')} -{' '}
