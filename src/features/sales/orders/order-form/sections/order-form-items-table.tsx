...
import type { CreateSalesOrderFormData, SalesOrderItemFormData, UpdateSalesOrderFormData } from '../types/order-form.schema'
import { OrderItemsTable } from '../components/order-items-table'

export function OrderFormItems() {
  const [itemsAmount, setItemsAmount] = useState(1)

  const form = useFormContext<CreateSalesOrderFormData>()
    ...
    <div className='flex flex-col space-y-3'>
      <div className='flex items-center justify-between'>
        <div className='flex items-center gap-1.5'>
          <h3 className='text-md font-medium'>Item Order</h3>
      ...
      <OrderItemsTable 
        fields={fields as unknown as SalesOrderItemFormData[]} 
        remove={remove} 
        form={form as unknown as UseFormReturn<CreateSalesOrderFormData | UpdateSalesOrderFormData>} 
      />
