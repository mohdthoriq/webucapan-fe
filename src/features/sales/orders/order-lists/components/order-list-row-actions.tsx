...
export function DataTableRowActions<TData>({
  ...
  const canEdit = useHasPermission(PERMISSION_KEY.SALES_ORDER_EDIT)
  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        desc='Apakah Anda yakin ingin menghapus sales order ini? Tindakan ini tidak dapat dibatalkan.'
        confirmText='Hapus'
        destructive
