    ...
    <Card className={cn('bg-card border-border flex flex-col', className)}>
      <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
        ...
        <div className='flex items-center gap-1'>
          <CardAction period={period} onChange={handlePeriodChange} setDateRange={setDateRange} setPeriod={setPeriod} dateRange={dateRange} />
        </div>
      </CardHeader>

      <div className='px-6 pb-2'>
        <div className='border-border flex w-fit items-center rounded-lg border p-1'>
          <button
